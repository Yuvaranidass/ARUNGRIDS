  ...
  return (
    <div className="px-4">
      ...
      <div className="is-flex is-justify-content-space-between">
        ...
        <div>
          <button className="button is-info">Save Purchase Return</button>
        </div>
      </div>
          ...
          <div className="column is-7">
            <div className="columns">
              <div className="column is-6">
                <div className="mt-4">
                purchase return No:  {invoiceNumber}
                </div>
                <div className="mt-5">purchase return Date:   {invoiceDate}</div>
              </div>
              <div className="column is-6">
...
PurchaseReturnInvoice.propTypes = {
