...
import { faPercent, faRupeeSign, faArrowLeft } from '@fortawesome/free-solid-svg-icons';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { useSiteContext } from '../../../context/SiteDarkProvider';
import SalesInvoicePopup from './SalesInvoicePopup';
import QuotationInvoicePopup from './QuotationInvoicePopup';
        ...
        <div className="px-4">
            ...
            <div className="is-flex is-justify-content-space-between">
                <div className="subtitle">
                    <span className="icon is-clickable" onClick={closeModal}>
                        <FontAwesomeIcon icon={faArrowLeft} />
                    </span>
                    Create Quotation
                </div>
                <div>
                    <button className="button is-info">Save Quotation Invoice</button>
                </div>
            </div>
            ...
            {/* Bill To */}
            <div className="box">
                <div className="subtitle"><b><center>Bill To</center></b></div>
                <hr />
                <div className="columns align-items-center">
                    <div className="column is-7">
                        <div className="columns">
                            <div className="column is-6">
                                <div className="mt-4">Quotation Number: {invoiceNumber}</div>
                                <div className="mt-5"> Quotation Date: {invoiceDate}</div>
                            </div>
                            <div className="column is-6">
                    ...
                    <div className="column is-5 border-left">
                        ...
                        <div>
                            <select className="select input op" id="partySelect" onChange={handlePartySelect}>
            ...
            <div className="container card" id="infoContainer" style={{ display: selectedParty ? 'block' : 'none' }}>
                <div className="is-flex is-justify-content-space-around">
                    <div className="section">
                        <button className="button is-info" onClick={() => handlePopup('changePartyPopup')}>
                            Change Party
                        </button>
                        <div className="info mt-5">
                            <strong>{selectedParty}</strong><br />
                            <span>Phone Number: {selectedParty === 'barath' ? '1234567890' : '0987654321'}</span>
                        </div>
                    </div>
                    <div className="section">
                        <button className="button is-info" onClick={() => handlePopup('changeShippingAddressPopup')}>
            ...
            {/* Popup Form */}
            <div className={`popup ${popup === 'changeShippingAddressPopup' ? 'show' : ''}`} id="changeShippingAddressPopup">
                <div className="popup-content">
                    ...
                    <form>
                        ...
                        <div className="field is-grouped">
                            ...
                            <div className="control">
                                <button className="button is-danger" type="button" onClick={closePopup}>
                                    Cancel
                                </button>
                            </div>
                        </div>
            ...
            <div>
                ...
                <div className='addproperty' onClick={createitem}>+Add Item</div>
            </div>
            <div className='columns columns-equal-height mt-3'>
                <div className='column is-6 column-equal-height'>
                    <div className='box box-equal-height'>
                        <p className='has-text-link' onClick={handleAddNoteClick} style={{ cursor: 'pointer' }}>
                            +Add Note
                        </p>
                        {showTextarea && (
                            <textarea
                ...
                <div className='column is-6 column-equal-height'>
                    <div className='box box-equal-height'>
                        <div className="is-divider has-text-weight-bold" data-content="Taxable Amount"></div>
                        <div className='columns'>
                        ...
                        >
                            ...
                            />
                            {!imagePreview && (
                                <span id="addPartyText" style={{ marginBottom: '10px', fontSize: '16px' }}>
                                    +Add Signature
                                </span>
                            )}
                            {imagePreview && (
...
export default CreateQuotationInvoice;
