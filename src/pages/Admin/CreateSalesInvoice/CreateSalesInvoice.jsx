...
function CreateSalesInvoice() {
  ...
  useEffect(() => {
    let lastChallanNumber = localStorage.getItem("challanNumber");
    if (!lastChallanNumber) {
      lastChallanNumber = 1;
    } else {
      lastChallanNumber = parseInt(lastChallanNumber);
    }

    setChallanNumber(lastChallanNumber);

    const nextChallanNumber = lastChallanNumber + 1;
    localStorage.setItem("challanNumber", nextChallanNumber);

    const currentDate = new Date();
    setChallanDate(currentDate.toLocaleDateString());
  ...
  return (
    <div className="px-4">
      ...
      <div className="is-flex is-justify-content-space-between">
        ...
        <div>
          <button className="button is-info">Save Sales Invoice</button>
        </div>
      </div>
