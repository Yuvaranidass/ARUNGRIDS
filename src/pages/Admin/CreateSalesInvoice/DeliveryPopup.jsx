...
import DeliveryInvoicePopup from './DeliveryInvoicePopup';



function CreateDeliveryInvoice() {
    ...
    return (
        <div className="px-4">
            ...
            <div className="is-flex is-justify-content-space-between">
                ...
                <div>
                    <button className="button is-info">Save delivery challan</button>
                </div>
            </div>
                    ...
                    <div className="column is-7">
                        <div className="columns">
                            <div className="column is-6">
                                <div className="mt-4">Challan Number: {invoiceNumber}</div>
                                <div className="mt-5"> Challan Date: {invoiceDate}</div>
                            </div>
                            <div className="column is-6">
...
export default CreateDeliveryInvoice;
