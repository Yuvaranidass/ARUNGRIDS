...
import ReturnInvoicePopup from './ReturnInvoicePopup';
    ...
    return (
        <div className="px-4">
            ...
            <div className="is-flex is-justify-content-space-between">
                ...
                <div>
                    <button className="button is-info">Save sales return Invoice</button>
                </div>
            </div>
                    ...
                    <div className="column is-7">
                        <div className="columns">
                            <div className="column is-6">
                                <div className="mt-4">sales return   Number: {invoiceNumber}</div>
                                <div className="mt-5"> sales return Date: {invoiceDate}</div>
                            </div>
                            <div className="column is-6">
