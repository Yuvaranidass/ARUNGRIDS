...
import DebitNoteInvoice from '../CreatePurchaseInvoice/DebitnoteInvoice';
...
function DebitNote() {
  ...
  return (
    <div className=" px-4 py-3 ">
      <div className="subtitle has-text-weight-bold">DEBIT NOTE</div>
      <div className="card smart-admin-container py-2 px-2 ">
        <form onSubmit={handleSubmit}>
          <div className="columns my-2 is-flex is-justify-content-space-between">
