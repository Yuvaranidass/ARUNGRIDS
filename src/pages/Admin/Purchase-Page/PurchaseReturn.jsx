...
import PurchaseReturnInvoice from '../CreatePurchaseInvoice/PurchaseReturnInvoice';
...
function PurchaseReturn() {
  ...
  return (
    ...
    <div className="  px-4 py-3 ">
      <div className="subtitle has-text-weight-bold">PURCHASE RETURN</div>
