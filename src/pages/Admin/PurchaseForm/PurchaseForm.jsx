...
const PurchaseForm = ({ loadTableData, dataIn }) => {
    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
          <div className="columns">
              ...
              <div className="field">
                <label className="label  has-text-link">Purchase Name</label>
                ...
                <div className="column is-6">
              <div className="field">
                  <label className="label has-text-link">Payment Type</label>
          ...
          <div className="columns">
              ...
              <div className="column is-6">
              <div className="field">
                <label className="label has-text-link">Due Date</label>
                <div className="control">
                  <input
                    type="date"
            ...
            <div className="column is-4">
              <div className="field">
                <label className="label has-text-link">Total Amount</label>
                <div className="control">
                  <input
                    type="text"
